...
mpg321 -g 100 "/home/pi/Github/soundservicePi/sounds/Computer Beeps (1s).mp3"
HOUR=`date +%H`
MINUTE=`date +%M`
...
sudo convert /home/pi/Github/rfoutlet/LivingOrig${HOUR}-${MINUTE}.jpg -rotate 270 /home/pi/Living${HOUR}-${MINUTE}.jpg
